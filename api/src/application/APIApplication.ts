...
export default class APIApplication {
    ...
    constructor(accountService: AccountService, webSiteService: WebSiteService, sessionService: SessionService, modelService: ModelService, generatorService: GeneratorService) {
