...
You are participating to a crowdtesting session ! Your goal is to explore the purchase funnel of amazon. You are guided by a pink ball animation that shows you the way. You have to follow a list of step, but also make your test a bit unique.
...
2. On the page that opens, enter the code-url and press enter: https://researchexperimentation.fr/join?sessionId=d11x672uE&modelId=h1oMtbTEx
